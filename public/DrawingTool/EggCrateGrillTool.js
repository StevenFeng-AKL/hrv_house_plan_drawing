function EggCrateGrillTool(drawingArea) {
    var that = this;
    var isDrawing = false;
    ...
    function toolPaint() {
        ...
        var w = 24, h = 12;
        toolCtx.strokeRect(-w/2, -h/2, w, h);
        toolCtx.beginPath();
        toolCtx.moveTo(-w/6, -h/2); toolCtx.lineTo(-w/6, h/2);
        toolCtx.moveTo(w/6, -h/2); toolCtx.lineTo(w/6, h/2);
        toolCtx.moveTo(-w/2, 0); toolCtx.lineTo(w/2, 0);
        toolCtx.stroke();
